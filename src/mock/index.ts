...
export const mockDevices: Device[] = [
  ...
  { id: 'd3', name: '造雪机I1-01', code: 'SM-I01', type: 'snowmaker', location: '中级道上段', status: 'maintenance', runHours: 1652, maintenanceInterval: 500, lastMaintenance: '2026-04-10', nextMaintenance: '2026-06-18', powerConsumption: 0, waterConsumption: 0, efficiency: 82, connectedSlope: 's3', warningMessage: '待维修：运行时间达到维保阈值' } as Device,
  ...
  { id: 'd13', name: '缆车E线', code: 'CC-E1', type: 'cablecar', location: '高级道3号', status: 'maintenance', runHours: 2100, maintenanceInterval: 1000, lastMaintenance: '2026-03-15', nextMaintenance: '2026-06-14', powerConsumption: 0, waterConsumption: 0, efficiency: 0, connectedSlope: 's11', warningMessage: '维保中：牵引机构故障紧急维修' } as Device,
...
export const mockWorkOrders: WorkOrder[] = [
  ...
  { id: 'wo2', deviceId: 'd3', deviceName: '造雪机I1-01', deviceType: 'snowmaker', type: 'preventive', priority: 'high', status: 'assigned', description: '运行时间达到维保阈值，需要更换滤芯和润滑保养', teamId: 't1', teamName: '机电一班', assignee: '钱工', createdAt: dayjs().subtract(5, 'hour').format('YYYY-MM-DD HH:mm:ss'), scheduledDate: today, estimatedHours: 3, location: '中级道上段', reporter: '系统自动', originalDeviceStatus: 'warning', partsRequired: [{ partId: 'p1', partName: '水滤芯', quantity: 2, fulfilled: true }, { partId: 'p2', partName: '空气滤芯', quantity: 1, fulfilled: true }],
    operationLogs: [
  ...
  { id: 'wo4', deviceId: 'd19', deviceName: '压雪车3号', deviceType: 'snowgroomer', type: 'preventive', priority: 'high', status: 'pending', description: '即将到达保养里程，需进行全面保养', createdAt: dayjs().subtract(1, 'hour').format('YYYY-MM-DD HH:mm:ss'), scheduledDate: tomorrow, estimatedHours: 6, location: '车库', reporter: '系统自动', originalDeviceStatus: 'warning', partsRequired: [{ partId: 'p7', partName: '发动机机油', quantity: 30, fulfilled: false }, { partId: 'p8', partName: '履带螺栓', quantity: 40, fulfilled: true }],
    operationLogs: [
      { id: 'wo4_log1', action: 'created', timestamp: dayjs().subtract(1, 'hour').format('YYYY-MM-DD HH:mm:ss'), operator: '系统自动', note: '保养里程触发，等待派单' }
    ]
  },
  { id: 'wo5', deviceId: 'd16', deviceName: '魔毯3号', deviceType: 'magicarpet', type: 'corrective', priority: 'medium', status: 'pending', description: '皮带张紧器异响，需要检查调整或更换', createdAt: dayjs().subtract(30, 'minute').format('YYYY-MM-DD HH:mm:ss'), scheduledDate: tomorrow, estimatedHours: 2, location: '教学道', reporter: '教练-李', originalDeviceStatus: 'running', partsRequired: [{ partId: 'p9', partName: '张紧器总成', quantity: 1, fulfilled: false }],
    operationLogs: [
  ...
  { id: 'wo6', deviceId: 'd10', deviceName: '缆车B线', deviceType: 'cablecar', type: 'preventive', priority: 'low', status: 'pending', description: '月度例行：缆绳探伤+抱索器检查', createdAt: dayjs().format('YYYY-MM-DD HH:mm:ss'), scheduledDate: dayjs().add(3, 'day').format('YYYY-MM-DD'), estimatedHours: 4, location: '中级道1号', reporter: '系统自动', originalDeviceStatus: 'running', partsRequired: [],
    operationLogs: [
