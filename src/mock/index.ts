...
export const mockWorkOrders: WorkOrder[] = [
  { id: 'wo1', deviceId: 'd13', deviceName: '缆车E线', deviceType: 'cablecar', type: 'emergency', priority: 'urgent', status: 'in_progress', description: '牵引机构异常噪音，减速箱疑似故障，影响高级道3号运营', teamId: 't3', teamName: '索道专业组', assignee: '郑主管', createdAt: dayjs().subtract(3, 'hour').format('YYYY-MM-DD HH:mm:ss'), scheduledDate: today, startedAt: dayjs().subtract(2, 'hour').format('YYYY-MM-DD HH:mm:ss'), estimatedHours: 8, partsRequired: [{ partId: 'p5', partName: '减速箱轴承', quantity: 2, fulfilled: true }, { partId: 'p6', partName: '牵引轮衬垫', quantity: 4, fulfilled: true }] },
  { id: 'wo2', deviceId: 'd3', deviceName: '造雪机I1-01', deviceType: 'snowmaker', type: 'preventive', priority: 'high', status: 'assigned', description: '运行时间达到维保阈值，需要更换滤芯和润滑保养', teamId: 't1', teamName: '机电一班', assignee: '钱工', createdAt: dayjs().subtract(5, 'hour').format('YYYY-MM-DD HH:mm:ss'), scheduledDate: today, estimatedHours: 3, partsRequired: [{ partId: 'p1', partName: '水滤芯', quantity: 2, fulfilled: true }, { partId: 'p2', partName: '空气滤芯', quantity: 1, fulfilled: true }] },
  { id: 'wo3', deviceId: 'd8', deviceName: '造雪机P1-01', deviceType: 'snowmaker', type: 'preventive', priority: 'medium', status: 'in_progress', description: '计划维保：液压系统检测+喷嘴清洗校准', teamId: 't1', teamName: '机电一班', assignee: '孙技工', createdAt: dayjs().subtract(1, 'day').format('YYYY-MM-DD HH:mm:ss'), scheduledDate: today, startedAt: dayjs().subtract(4, 'hour').format('YYYY-MM-DD HH:mm:ss'), estimatedHours: 5, partsRequired: [{ partId: 'p3', partName: '喷嘴组', quantity: 12, fulfilled: true }, { partId: 'p4', partName: '液压油', quantity: 20, fulfilled: true }] },
  { id: 'wo4', deviceId: 'd19', deviceName: '压雪车3号', deviceType: 'snowgroomer', type: 'preventive', priority: 'high', status: 'pending', description: '即将到达保养里程，需进行全面保养', createdAt: dayjs().subtract(1, 'hour').format('YYYY-MM-DD HH:mm:ss'), scheduledDate: tomorrow, estimatedHours: 6, partsRequired: [{ partId: 'p7', partName: '发动机机油', quantity: 30, fulfilled: false }, { partId: 'p8', partName: '履带螺栓', quantity: 40, fulfilled: true }] },
  { id: 'wo5', deviceId: 'd16', deviceName: '魔毯3号', deviceType: 'magicarpet', type: 'corrective', priority: 'medium', status: 'pending', description: '皮带张紧器异响，需要检查调整或更换', createdAt: dayjs().subtract(30, 'minute').format('YYYY-MM-DD HH:mm:ss'), scheduledDate: tomorrow, estimatedHours: 2, partsRequired: [{ partId: 'p9', partName: '张紧器总成', quantity: 1, fulfilled: false }] },
  { id: 'wo6', deviceId: 'd10', deviceName: '缆车B线', deviceType: 'cablecar', type: 'preventive', priority: 'low', status: 'pending', description: '月度例行：缆绳探伤+抱索器检查', createdAt: dayjs().format('YYYY-MM-DD HH:mm:ss'), scheduledDate: dayjs().add(3, 'day').format('YYYY-MM-DD'), estimatedHours: 4, partsRequired: [] }
]
